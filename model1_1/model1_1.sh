...
#SBATCH --job-name=model1_1           #optional: job name
#SBATCH --output=./outfiles/model1_1_%j.out       #optional: file to store stdout from job, %j adds the assigned jobID
#SBATCH --error=./errorfiles/model1_1_%j.err        #optional: file to store stderr from job, %j adds the assigned jobID
