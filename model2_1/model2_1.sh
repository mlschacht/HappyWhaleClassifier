...
#SBATCH --job-name=model2_1           #optional: job name
#SBATCH --output=./outfiles/model2_1_%j.out       #optional: file to store stdout from job, %j adds the assigned jobID
#SBATCH --error=./errorfiles/model2_1_%j.err        #optional: file to store stderr from job, %j adds the assigned jobID
