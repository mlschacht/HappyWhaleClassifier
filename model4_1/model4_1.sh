...
#SBATCH --job-name=model4_1           #optional: job name
#SBATCH --output=./outfiles/model4_1_%j.out       #optional: file to store stdout from job, %j adds the assigned jobID
#SBATCH --error=./errorfiles/model4_1_%j.err        #optional: file to store stderr from job, %j adds the assigned jobID
