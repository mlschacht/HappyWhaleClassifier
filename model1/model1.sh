...
#SBATCH --job-name=model1           #optional: job name
#SBATCH --output=./outfiles/model1_%j.out       #optional: file to store stdout from job, %j adds the assigned jobID
#SBATCH --error=./errorfiles/model1_%j.err        #optional: file to store stderr from job, %j adds the assigned jobID
