...
def cm_analysis(y_true, y_pred, title, figsize=(10,10)):
    ...
    ax.set_title(title)
    plt.savefig("ConfusionMatrix3")

wandb.init(
    project="BGMP_HappyWhale",
    name="Makayla-model3", ##update this with your name
...
plt.savefig('./model3_accuracy.png')
...
plt.savefig('./model3_validation_loss.png') 
plt.close() 

y_pred, y_true = predict(model, test_set)
#cm_analysis(y_true, y_pred, "Confusionmatrix_model3.png", labels)
